...
It compares the  models, and then finally fits the “best” model to the test data. It also removes the clear outliers in the original analysis where the log(ReqAmt) was less than zero.
...
* Remove the obvious outliers (-log(ReqAmt))
...
analysisdata$logReqAmt <- log(analysisdata$ReqAmt)

#drop unnecessary variables
req_data_2 <- analysisdata %>%
              dplyr::select(-c(ReqAmt, disasterNumber, declarationTitle))

#specify all character variables as factors and clean variable names
req_data_1 <- req_data_2 %>% 
                janitor::clean_names() %>%
                dplyr::mutate_if(is.character, factor)

#remove outliers (rows that have a -log(reqamt))
req_data <- req_data_1 %>%
              dplyr::filter(log_req_amt > 0)
...
#save file
DT_auto_fig_file = here("results","DT-auto-plot-outlier.png")
...
#save file
DT_det_fig_file = here("results","DT-det-plot-outlier.png")
...
rpart.plot::rpart.plot(x = workflowsets::extract_fit_parsnip(best_tree_fit)$fit,
                                                     ...
                                                     shadow.col = "grey65",
                                                     col = "grey99")
#save manually as "DT-plot-outlier.png" -- ggsave throws an error
...
#save file
DT_pred_act_file = here("results","DT-pred-act-outlier.png")
...
#save file
DT_resid_file = here("results","DT-resid-outlier.png")
...
#save file
DT_pred_resid_file = here("results","DT-pred-resid-outlier.png")
...
#save file
RF_auto_fig_file = here("results","RF-auto-plot-outlier.png")
...
#save manually as "RF-plot-outlier.png" -- ggsave throws errors
...
#save file
RF_pred_act_file = here("results","RF-pred-act-outlier.png")
...
#save file
RF_resid_file = here("results","RF-resid-outlier.png")
...
#save file
RF_pred_resid_file = here("results","RF-pred-resid-outlier.png")
...
#save file
EN_auto_fig_file = here("results","EN-auto-plot-outlier.png")
...
#save manually as "EN-plot-outlier.png" -- ggsave throws errors
...
#save file
EN_pred_act_file = here("results","EN-pred-act-outlier.png")
...
#save file
EN_resid_file = here("results","EN-resid-outlier.png")
...
#save file
EN_pred_resid_file = here("results","EN-pred-resid-outlier.png")
...
#save file
lasso_auto_fig_file = here("results","lasso-auto-plot-outlier.png")
...
#save manually as "LASSO-plot-outlier.png" -- ggsave throws errors
...
#save file
lasso_pred_act_file = here("results","lasso-pred-act-outlier.png")
...
#save file
lasso_resid_file = here("results","lasso-resid-outlier.png")
...
#save file
lasso_pred_resid_file = here("results","lasso-pred-resid-outlier.png")
...
#save combined table
model_comp_file = here("results", "ML-model-comp-outlier.Rds")
...
#save combined table
test_comp_file = here("results", "test-train-model-comp-outlier.Rds")
...
#plot model predictions from tuned model versus actual outcomes
#geom_abline draws a 45 degree line, along which the results should fall
RF_pred_act_test <- ggplot2::ggplot(RF_resid_fit, aes(x = .pred, y = log_req_amt)) +
                        geom_abline(slope = 1, intercept = 0, color = "red", lty = 2) + 
                        geom_point(color = "#3b528b") +
                        labs(title = "RF Test Fit: Predicted vs. Actual Log(Requested Funds)",
                              x = "Predicted Log(Requested Funds) ($)",
                              y = "Actual Log(Requested Funds) ($)")
RF_pred_act_test

#save file
RF_pred_act_test_file = here("results","RF-pred-act-test-outlier.png")
...
#save file
RF_resid_test_file = here("results","RF-resid-test-outlier.png")
...
RF_pred_resid_test <- ggplot2::ggplot(RF_resid_fit, aes(x = .pred, y = .resid))+
                          geom_hline(yintercept = 0, color = "red", lty = 2) +
                          geom_point(color = "#3b528b") +
                          labs(title = "RF Test Fit: Residuals vs Fitted Log(Requested Funds)",
                                x = "Predicted Log(Requested Funds) ($)",
                                y = "Residuals")
RF_pred_resid_test

#save file
RF_pred_resid_test_file = here("results","RF-pred-resid-test-outlier.png")
