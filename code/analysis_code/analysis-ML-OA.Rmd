...
#load data. 
obl_data <- readRDS(data_location)
...
obl_data$logOblAmt <- log(obl_data$OblAmt)
...
#save file
DT_auto_fig_file = here("results","DT-auto-plot-OA.png")
...
#save file
DT_det_fig_file = here("results","DT-det-plot-OA.png")
...
rpart.plot::rpart.plot(x = workflowsets::extract_fit_parsnip(best_tree_fit)$fit,
                                                     ...
                                                     shadow.col = "grey65",
                                                     col = "grey99")
#save manually as "DT-plot-OA.png" -- ggsave throws an error
...
#save file
DT_pred_act_file = here("results","DT-pred-act-OA.png")
...
#save file
DT_resid_file = here("results","DT-resid-OA.png")
...
#save file
DT_pred_resid_file = here("results","DT-pred-resid-OA.png")
...
#save file
RF_auto_fig_file = here("results","RF-auto-plot-OA.png")
...
#save manually as "RF-plot-OA.png" -- ggsave throws errors
...
#save file
RF_pred_act_file = here("results","RF-pred-act-OA.png")
...
#save file
RF_resid_file = here("results","RF-resid-OA.png")
...
#save file
RF_pred_resid_file = here("results","RF-pred-resid-OA.png")
...
#save file
EN_auto_fig_file = here("results","EN-auto-plot-OA.png")
...
#save manually as "EN-plot-OA.png" -- ggsave throws errors
...
#save file
EN_pred_act_file = here("results","EN-pred-act-OA.png")
...
#save file
EN_resid_file = here("results","EN-resid-OA.png")
...
#save file
EN_pred_resid_file = here("results","EN-pred-resid-OA.png")
...
#save file
lasso_auto_fig_file = here("results","lasso-auto-plot-OA.png")
...
#save manually as "LASSO-plot-OA.png" -- ggsave throws errors
...
#save file
lasso_pred_act_file = here("results","lasso-pred-act-OA.png")
...
#save file
lasso_resid_file = here("results","lasso-resid-OA.png")
...
#save file
lasso_pred_resid_file = here("results","lasso-pred-resid-OA.png")
...
#save combined table
model_comp_file = here("results", "ML-model-comp-OA.Rds")
...
#save combined table
test_comp_file = here("results", "test-train-model-comp-OA.Rds")
...
#plot model predictions from tuned model versus actual outcomes
#geom_abline draws a 45 degree line, along which the results should fall
lasso_pred_act_test <- ggplot2::ggplot(lasso_resid_fit, aes(x = .pred, y = log_obl_amt)) +
                        geom_abline(slope = 1, intercept = 0, color = "red", lty = 2) + 
                        geom_point(color = "#3b528b") +
                        labs(title = "LASSO Test Fit: Predicted vs. Actual Log(Obligated Funds)",
                              x = "Predicted Log(Obligated Funds) ($)",
                              y = "Actual Log(Obligated Funds) ($)")
lasso_pred_act_test

#save file
lasso_pred_act_test_file = here("results","lasso-pred-act-test-OA.png")
...
#save file
lasso_resid_test_file = here("results","lasso-resid-test-OA.png")
...
lasso_pred_resid_test <- ggplot2::ggplot(lasso_resid_fit, aes(x = .pred, y = .resid))+
                          geom_hline(yintercept = 0, color = "red", lty = 2) +
                          geom_point(color = "#3b528b") +
                          labs(title = "LASSO Test Fit: Residuals vs Fitted Log(Obligated Funds)",
                                x = "Predicted Log(Obligated Funds) ($)",
                                y = "Residuals")
lasso_pred_resid_test

#save file
lasso_pred_resid_test_file = here("results","lasso-pred-resid-test-OA.png")
