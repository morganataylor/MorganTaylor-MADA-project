...
* `ResponseDays` are missing 72% of the time, which suggests it should not be included in the analysis.
...
decs_state_5 <- EDAdata %>%
                    ...
                    gtsummary::modify_caption("**Table 1. FEMA Funding for 5 Most Disaster-Prone States 2012 - 2021**") %>%
...
table1 <- table1::table1(~ ReqAmt + OblAmt + state + IncidentYear + IncidentMonth + declarationType + incidentType +
                           IncidentDuration + IH + PA + HM + Population + Counties + TotalAgencies + FEMACSAvg,
                          data = EDAdata)
