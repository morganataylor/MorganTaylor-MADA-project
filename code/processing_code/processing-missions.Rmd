...
```
There are 22 variables in the raw dataset and 21,472 observations. However, there are multiple observations for each disaster declaration and state, as they are listed by each request for assistance or ammendment for funding. Time to clean!
...
We now have our processed dataset for mission assignments! Let's save it into the `processed_data` folder.
